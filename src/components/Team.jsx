...
const Team = () => {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            transformDefault: 'scale(1.3) translateY(8%)',
            transformHover: 'scale(1.4) translateY(8%)',
            transformDefaultMobile: 'scale(1.3) translateY(8%)',
            transformHoverMobile: 'scale(1.4) translateY(8%)',
