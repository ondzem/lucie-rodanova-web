...
const Team = () => {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            transformDefault: 'scale(1.13) translateY(2%)',
            transformHover: 'scale(1.23) translateY(2%)',
            transformDefaultMobile: 'scale(1.07) translateY(2%)',
            transformHoverMobile: 'scale(1.17) translateY(2%)',
