...
const Team = () => {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            transformDefault: 'scale(1.2) translateY(6.5%)',
            transformHover: 'scale(1.3) translateY(6.5%)',
            transformDefaultMobile: 'scale(1.2) translateY(6.5%)',
            transformHoverMobile: 'scale(1.3) translateY(6.5%)',
